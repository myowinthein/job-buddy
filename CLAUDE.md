...
- `src/resume-ai/normalize.ts`: `normalizeBullets()` + `normalizeSummaryLineWraps()`. Bullet pass fires only when bullet structure is detected, preserving plain context paragraphs.
